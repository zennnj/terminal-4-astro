...
- The REVIEW directory uses a compact yellow latest-review feature card with its orange badge above the card's vertical midpoint, followed by a two-column desktop list. Filter selection is a contained capsule. Category markers are circles, dates remain visible, and filtered results paginate at 20 entries per page with a bottom page count and navigation.
