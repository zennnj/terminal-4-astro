 ...
 */
export const site = {
  title: 'Terminal 4', // required
  favicon: '/favicon.svg', // required
  description: '文章、随想、作品与生活记录。',
  author: "zennnj", // required
  avatar: '/images/lol.jpg', // required
  url: 'https://zennnj.github.io', // required
...
export const infoLinks = [
  {
    icon: 'ri-github-fill',
    name: 'github',
    outlink: 'https://github.com/zennnj',
  },
  {
    icon: 'ri-rss-fill',
    name: 'rss',
...
export const comment = {
  ...
  walineConfig: {
    serverUrl: "https://waline-blog-tau-three.vercel.app/",
    lang: 'en',
    pageSize: 20,
    wordLimit: '',
    count: 5,
